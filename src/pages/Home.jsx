  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 mb-8">
        <HomeIcon className="w-8 h-8 text-black dark:text-white" />
        <h1 className="text-4xl font-bold text-black dark:text-white">Home</h1>
      </div>
      <div className="bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-8 transition-colors duration-300">
        <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-100">Welcome to your Dashboard</h2>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-white dark:bg-gray-700 p-6 rounded-xl border border-gray-100 dark:border-gray-600 shadow-sm transition-colors duration-300">
            <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">Quick Start</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Upload your resume to begin the interview process.</p>
          </div>
          <div className="bg-white dark:bg-gray-700 p-6 rounded-xl border border-gray-100 dark:border-gray-600 shadow-sm transition-colors duration-300">
            <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">Recent Activity</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">No recent interviews found.</p>
          </div>
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="bg-white dark:bg-gray-700 border border-gray-100 dark:border-gray-600 rounded-2xl p-6 shadow-sm flex flex-col md:flex-row gap-8 items-center transition-colors duration-300">
            <div className="w-full md:w-80 aspect-video bg-gray-900 rounded-xl overflow-hidden shadow-inner border border-gray-100 dark:border-gray-800 relative group">
              <Webcam
                audio={false}
            ...
            <div className="flex-1">
              <h3 className="text-lg font-bold text-black dark:text-white mb-2">Face Monitoring Active</h3>
